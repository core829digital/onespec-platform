...
const de: WidgetDict = {
  ...
  viewNote: '"Links" / "Rechts" werden von innen nach außen betrachtet — die Standardkonvention.',
  ...
  directionLabel: "Öffnungsseite",
  directions: [["left", "Links"], ["right", "Rechts"]],
  ...
  diagramLegend: "Dreieck = Scharnier-/Kippseite, gerader Pfeil = Schieferichtung",
...
const nl: WidgetDict = {
  ...
  viewNote: '"Links" / "Rechts" worden bekeken van binnen naar buiten — de standaardconventie.',
  ...
  directionLabel: "Openingsrichting",
  directions: [["left", "Links"], ["right", "Rechts"]],
  ...
  diagramLegend: "Driehoek = scharnier/kip-kant, rechte pijl = schuifrichting",
